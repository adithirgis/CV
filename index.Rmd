...
An enthusiastic R and Python developer. Working on mobile monitoring of air quality in Bangalore as a Geospatial data analyst. Currently seeking a PhD position in geospatial data analysis.
...
- Managed the database of big data sets.
- Generated high-resolution maps using QGIS.

### Elephant Atlas

Asian Nature Conservation Foundation, GIS Consultant

Bangalore, India

2020 - Present

In progress : Elephant Atlas for the Karnatake State.
...
Consulted on a story on [PM2.5 personal exposures](https://www.nytimes.com/interactive/2020/12/17/world/asia/india-pollution-inequality.html?smtyp=cur&smid=tw-nytimes&s=08) in Delhi neighborhoods.

### Velocity estimation in the Amery Ice Shelf, Antarctica
...
Master Thesis, Bharati Vidyapeeth Institute of Environment Education and Research
...
### R package
Maintainer and creater of [mmaqshiny](https://github.com/meenakshi-kushwaha/mmaqshiny) on [CRAN](https://cran.r-project.org/web/packages/mmaqshiny/index.html).
...
### Application
Maintainer of [Pollucheck](https://github.com/adithirgis/OpenSourceAirQualityApp).
...
Puttaswamy N, Vakacherla S, Pillarisetti A, **Upadhya AR**, Veerapan B, Saidam S, Sutaria R, Mukhopadhyay K, Sambandam S, Balakrishnan K.
